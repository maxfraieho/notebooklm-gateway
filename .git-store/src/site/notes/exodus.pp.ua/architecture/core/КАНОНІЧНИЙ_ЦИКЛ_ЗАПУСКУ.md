...
- [[exodus.pp.ua/architecture/foundation/АРХІТЕКТУРНИЙ_КОРІНЬ\|АРХІТЕКТУРНИЙ_КОРІНЬ]] — §5 Canonical Flow: стани requested → queued → running → completed/failed

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/core/АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ\|АБСТРАКЦІЯ_РІВНЯ_ОРКЕСТРАЦІЇ]] — Orchestration Layer wrapper є canonical status writer
- [[exodus.pp.ua/architecture/core/КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА\|КАНОНІЧНА_МОДЕЛЬ_АВТОРИТЕТУ_СХОВИЩА]] — status.json writer contract (§2.2)

**Від цього документа залежать:**
- [[exodus.pp.ua/architecture/core/КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ\|КАНОНІЧНИЙ_КОНВЕЄР_ВИКОНАННЯ]] — кожна фаза pipeline відповідає стану lifecycle
- [[exodus.pp.ua/operations/INBOX_ТА_ЦИКЛ_ЗАПУСКУ_V1\|INBOX_ТА_ЦИКЛ_ЗАПУСКУ_V1]] — frontend-orієнтований витяг цього lifecycle
