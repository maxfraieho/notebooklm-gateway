...
- [[exodus.pp.ua/architecture/features/DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА\|DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА]] — технічний фундамент інтеграції

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/features/DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА\|DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА]] — специфікує що треба інтегрувати

**Від цього документа залежають:**
- [[exodus.pp.ua/drakon/СТРАТЕГІЯ_ІНТЕГРАЦІЇ\|СТРАТЕГІЯ_ІНТЕГРАЦІЇ]] — стратегія базується на цьому дослідженні
- [[exodus.pp.ua/drakon/АНАЛІЗ_ПРОЕКТУ\|АНАЛІЗ_ПРОЕКТУ]] — аналіз використовує результати дослідження
