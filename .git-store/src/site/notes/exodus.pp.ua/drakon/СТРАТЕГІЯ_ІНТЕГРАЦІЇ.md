...
- [[exodus.pp.ua/architecture/features/DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА\|DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА]] — реалізаційна стратегія для DRAKON

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/features/DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА\|DRAKON_ІНТЕГРАЦІЯ_ТА_МОДЕЛЬ_ВИКОНАННЯ_АГЕНТА]] — специфікація DRAKON runtime
- [[exodus.pp.ua/drakon/ДОСЛІДЖЕННЯ_DRAKONWIDGET\|ДОСЛІДЖЕННЯ_DRAKONWIDGET]] — технічне дослідження компонента

**Від цього документа залежають:**
- [[exodus.pp.ua/drakon/ВИБІР_НАВИЧОК_CLAUDE\|ВИБІР_НАВИЧОК_CLAUDE]] — конкретні навички для реалізації стратегії
- [[exodus.pp.ua/drakon/АНАЛІЗ_ПРОЕКТУ\|АНАЛІЗ_ПРОЕКТУ]] — контекст проекту інформує стратегію
