...
- [[exodus.pp.ua/architecture/КАРТА_ГРАФУ\|КАРТА_ГРАФУ]] — деталізує статус документів у графі знань

**Цей документ залежить від:**
- [[exodus.pp.ua/architecture/КАРТА_ГРАФУ\|КАРТА_ГРАФУ]] — граф вузлів та їх tier
- [[exodus.pp.ua/ІНДЕКС\|ІНДЕКС]] — первинна точка входу, що використовує цей інвентар
